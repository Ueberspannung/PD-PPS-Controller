...
class convert_c
{
	public:
		...
		convert_c(int32_t data, uint8_t decimals=0);
		...
		char* getStringUnsignedZeros(char *buffer, uint8_t size, uint8_t decimals, bool null=true);
		...
		char* getStringTime(char* buffer, bool bDays, uint8_t decimals);
