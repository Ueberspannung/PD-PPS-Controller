...
void parameter::setCVCC(regulator_mode_et mode)
{	// setCVCC
...
void parameter::setVoltageStep(uint16_t VoltageStep)
{	//	setVoltageStep
	Parameter.setU=VoltageStep;
}	//	setVoltageStep

void parameter::setCurrentStep(uint16_t CurrentStep)
{	//	setVoltageStep
...
parameter::regulator_mode_et parameter::getCVCC(void)
{	// getCVCC
	return (regulator_mode_et)Parameter.CVCC;
}	// getCVCC
...
uint16_t parameter::getVoltageStep(void)
{	// getVoltageStep
	return Parameter.setU;
}	// getVoltageStep

uint16_t parameter::getCurrentStep(void)
{	// getCurrentStep
...
{	//	setInitData
	...
	Parameter.Brightness=0; 	// backlight off
	...
	Parameter.CVCC		=regulator_mode_off;
